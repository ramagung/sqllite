...
import "package:sqllite_database/ui/uientryform.dart";
import 'package:sqllite_database/models/mkontak.dart';
import 'package:sqllite_database/helpers/hdatabases.dart';
...
class Database {
  ...
  insert(String s, Map<String, > map) {}
